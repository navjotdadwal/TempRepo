...
import com.example.dadwalsocialmedia.*
import com.google.android.material.floatingactionbutton.FloatingActionButton
import java.util.*

class MainnotesActivity : AppCompatActivity(), NoteClickInterface, NoteClickDeleteInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addFAB.setOnClickListener {
            ...
            val intent = Intent(this@MainnotesActivity, AddEditNoteActivity::class.java)
